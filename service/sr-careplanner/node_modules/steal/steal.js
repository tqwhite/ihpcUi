...
define(function(require) {
	...
	return function unhandledRejection(Promise) {
		...
		if(typeof console !== 'undefined') {
			...
			//Modified by tqii, 9/19/23
			//was: localConsole = console;
			
			localConsole = {
				error: msg=>console.log(`error ignored by $projectRoot/node_modules/steal/steal.js`),
				info: msg=>console.log(`info ignored by $projectRoot/node_modules/steal/steal.js`),
				log: msg=>console.log(`log ignored by $projectRoot/node_modules/steal/steal.js`),
			};
			//end of tqii mods
...
(function() {
  ...
  function linkSetFailed(linkSet, load, exc) {
    ...
    exc = addToError(exc, 'Error loadingS "' + load.name + '" at ' + (load.address || '<unknown>') + '\n');
