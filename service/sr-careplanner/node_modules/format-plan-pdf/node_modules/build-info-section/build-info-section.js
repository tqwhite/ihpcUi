		...
		const finalDocSpec = {
			...
			body: [
				[
					...
					assembleTextCell('text', [{text: '504: ',bold: true}, {text: '1/1/00'}], '', '', '', ''),
					assembleTextCell('text', [{text: 'EVP: ',bold: true}, {text: '1/1/00'}], '', '', '', ''),
					assembleTextCell('text', [{text: 'EAP: ',bold: true}, {text: '1/1/00'}], '', '', '', ''),
				],

				[
					assembleTextCell('text', [{text: 'Written by: : ',bold: true}, {text: dictionary('writtenby')}]),
					assembleTextCell('text', 'IHP: '+plan('createdAt', standardDate)),
					assembleTextCell('text', [{text: 'IEP: ',bold: true}, {text: '1/1/00'}], '', '', '', ''),
